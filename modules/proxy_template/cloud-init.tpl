...
docker-compose --file $SHADOWSOCKS_HOME/${artifacts.compose_file} %{ if artifacts.compose_override_file != null } --file ${artifacts.compose_override_file} %{ endif } up --detach
